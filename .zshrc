...
export P4PORT='perforce.corp.xfire.com:1666'
export P4PASSWD='chad123'
...
setopt   autoparamkeys autoremoveslash chaselinks extendedhistory hashcmds 
setopt   hashdirs histignoredups nobadpattern nobeep
setopt   autocd longlistjobs alwaystoend
setopt   nohistbeep nohup nonomatch notify zle path_dirs rm_star_silent
setopt   autoresume histignoredups pushdsilent noclobber
setopt   autopushd pushdminus extendedglob rcquotes list_types monitor
unsetopt bgnice correct correctall noflowcontrol markdirs pathdirs recexact
unsetopt mailwarning notify noclobber completeinword ignore_eof cdablevars autocd

# watch for my friends
watch=(`cat .friends`)
#WATCHFMT='%n %a %l from %m at %t.'
WATCHFMT="%B %n %b[%B%l%b] %a at %t %W"
LOGCHECK=60
